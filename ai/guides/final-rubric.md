...
| Friends-and-family interviews accepted | Must include interviews outside your immediate social circle — target users, strangers, or domain contacts. Friends-and-family can supplement but cannot be the source. |
...
Show us what you got wrong — or what you didn't see — at midterm. What new elements, relationships, or feedback loops did you discover by actually operating in this system? Which leverage points did you try to pull, and what happened? Your diagram should look different because your understanding is different. If it hasn't changed, either you got it perfectly right the first time (show us evidence) or you haven't been paying attention.
...
- **Subdeadline:** Monday April 7 at 23:59. All project code, documentation, and presentation materials must be committed and pushed by this deadline, regardless of which day you present. No exceptions, no late submissions. Work pushed after this deadline will not be graded.
...
- Start from where midterm left off — don't reintroduce your idea
...
- Paying customers, revenue, or a business model. We are not grading your revenue model or business plan. We DO expect evidence of customer research and engagement -- interviews, feedback sessions, prototype testing with real people. At final, you must include interviews with people outside your immediate social circle — people who do not have a built-in bias toward your product. Friends and family can supplement your research, but your primary customer evidence should come from target users, domain contacts, or strangers.
...
- [ ] Success/failure criteria tested against reality — can report where they stand
