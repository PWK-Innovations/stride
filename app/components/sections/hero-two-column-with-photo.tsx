  ...
  return (
    <section className={clsx('py-16', className)} {...props}>
      <Container className="flex gap-16 max-xl:flex-col">
        ...
        <div className="flex min-h-[340px] flex-1 overflow-hidden rounded-xl outline -outline-offset-1 outline-black/5 *:object-cover dark:outline-white/5 xl:min-h-[420px]">
          {photo}
        </div>
      </Container>
    </section>
